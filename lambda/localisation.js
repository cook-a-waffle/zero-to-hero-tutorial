module.exports = {
    ...
    it: {
        translation: {
            ...
            POST_CELEBRITIES_HELP_MSG: 'Tocca le immagini per avere ulteriori info su di loro. Puoi anche chiedermi quanto manca al tuo compleanno, oppure creare anche un promemoria. Cosa vuoi fare? ',
            LAUNCH_HEADER_MSG: 'Buon Compleanno',
            LAUNCH_HINT_MSG: ['quanto manca al mio compleanno?', 'chi compie gli anni oggi?', 'crea un promemoria per il mio compleanno', 'segnati la mia data di compleanno'],
            LIST_HEADER_MSG: `I compleanni di oggi`,
            LIST_HINT_MSG: 'chi è nato oggi?',
            LIST_YO_ABBREV_MSG: '{{count}} anno',
            LIST_YO_ABBREV_MSG_plural: '{{count}} anni',
            LIST_PERSON_DETAIL_MSG: `{{person.humanLabel.value}} nacque {{person.date_of_birth.value}} anni fa a {{person.place_of_birthLabel.value}}. `,
            POST_TOUCH_HELP_MSG: `Prova a toccare sulle altre celebrità per avere più info su di loro. Altrimenti puoi chiedermi quanti giorni mancano al tuo compleanno o creare un promemoria. Cosa vuoi fare? `
        }
    },
    fr: {
        translation: {
